...
('童年的铁皮青蛙', '铁皮青蛙', '上弦的铁皮青蛙，一拧就能跳老远，是那个年代最经典的玩具之一。', '记得是过生日时爷爷给买的，当时爱不释手，睡觉都要放在枕头边。', '现在看到它，仿佛又回到了那个无忧无虑的童年时光。', '80年代中国制造的铁皮玩具风靡全国，采用镀锡铁皮冲压工艺，经久耐用。铁皮青蛙、铁皮坦克、铁皮小汽车是那个年代孩子最渴望的礼物，价格约一两元钱，相当于家长大半天的工资。', '如今作为珍贵收藏品摆放在家中书架的玻璃柜中，每次整理旧物看到它，都会拿出来给孩子演示上弦跳跃，讲述那个简单快乐的童年。', '略有锈迹', '1988年六一儿童节爷爷赠送的生日礼物，伴随整个童年，如今作为珍贵收藏摆放在书架上。', '["https://picsum.photos/seed/frog1/600/400"]', 4, 3, 256, '李阿姨'),
('老款双卡录音机', '双卡录音机', '当年的奢侈品，能拥有一台双卡录音机是多么让人羡慕的事情。', '这台录音机是哥哥从南方带回来的，当时可是稀罕物。', '记得用它录了好多磁带，邓丽君、谭咏麟的歌都是从这里听到的。', '90年代初双卡录音机是年轻人追求时尚的标志，支持磁带对录功能，可以翻录朋友的音乐磁带。一盒正版磁带约6-10元，对于学生来说价格不菲，因此互相磁带转录成为当时流行的音乐分享方式。', '2018年送给了对老物件感兴趣的侄儿，侄儿将其修复后放在自己的复古风格咖啡馆里，偶尔还会播放老磁带，引来很多顾客的好奇与赞叹。', '功能正常', '1992年哥哥从深圳带回的双卡录音机，录满了一抽屉磁带，陪伴度过无数个放学后的音乐时光。', '["https://picsum.photos/seed/radio1/600/400","https://picsum.photos/seed/radio2/600/400"]', 2, 4, 189, '王叔');

...
public enum PreservationStatus {
    PERFECT("完好", "✓", "#2e7d32", Arrays.asList("完好", "完美", "正常", "全新", "如新", "保存", "功能完好", "运行良好", "可正常使用", "完好保存", "功能正常")),
    REPAIRABLE("可修复", "🔧", "#f57c00", Arrays.asList("可修复", "能修", "可修理", "可维修", "修好", "修复", "待修复", "需要修", "要修", "修理", "待修", "需维修", "需修理", "破损待修", "破损", "坏", "故障", "损坏", "不能用", "无法使用")),
    MISSING_PARTS("缺件", "⚠️", "#c62828", Arrays.asList("缺", "少", "丢失", "缺件", "缺少", "零件丢失", "配件缺失", "不完整")),
    IMAGE_ONLY("仅留影像", "📷", "#6a1b9a", Arrays.asList("仅留影像", "只有照片", "只有图片", "仅剩照片", "仅剩图片", "实物遗失", "实物丢失", "只有影像", "照片留存", "图片留存")),
    UNDER_REPAIR("修复中", "⚙️", "#1565c0", Arrays.asList("修复中", "维修中", "正在修", "修理中", "维护中")),
    WORN("磨损", "📜", "#6d4c41", Arrays.asList("磨损", "旧", "锈", "划痕", "磨", "老化", "变旧", "使用痕迹", "陈旧", "略有锈迹", "有锈迹", "略有磨损")),
